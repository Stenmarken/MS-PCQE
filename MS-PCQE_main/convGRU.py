...
class ConvGRUCell(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, bias, dtype, v):
        """
...
class ConvGRU(nn.Module):
    def __init__(self, input_size, input_dim, hidden_dim, kernel_size, num_layers,
                 dtype, batch_first=False, bias=True, return_all_layers=False, v=1):
        """
    ...
    def forward(self, input_tensor, hidden_state=None):
        ...
        if hidden_state is not None:
            ...
            hidden_state = self._init_hidden(batch_size=hidden_state.size(0))
        else:
